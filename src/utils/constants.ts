export const BACKEND_URL = import.meta.env.VITE_BACKEND_URL || "https://tista.duckdns.org/api/operations";
export const FRONTEND_URL = import.meta.env.VITE_FRONTEND_URL || "https://tista.duckdns.org";
